...
class FavoritesController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Employees', 'Books', 'BookInfos'],
        ];
    ...
    public function add()
    {
        ...
        $employees = $this->Favorites->Employees->find('list', ['limit' => 200]);
        $books = $this->Favorites->Books->find('list', ['limit' => 200]);
        $bookInfos = $this->Favorites->BookInfos->find('list', ['limit' => 200]);
        $this->set(compact('favorite', 'employees', 'books', 'bookInfos'));
    }
